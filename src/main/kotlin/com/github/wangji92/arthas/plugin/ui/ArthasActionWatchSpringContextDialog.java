...
//    }
    ...
    private AnActionLink ognlDemoLink;
    private AnActionLink watchHelpLink;
    /**
     * spring 所有环境配置项信息获取
     */
    ...
    private void createUIComponents() {
        ...
        ognlDemoLink = new AnActionLink("", new AnAction() {
            @Override
            public void actionPerformed(AnActionEvent anActionEvent) {
        ...
        watchHelpLink = new AnActionLink("", new AnAction() {
            @Override
            public void actionPerformed(AnActionEvent anActionEvent) {

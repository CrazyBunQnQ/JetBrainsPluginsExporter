...
public class AppSettingsPage implements Configurable {
    ...
    private AnActionLink springContextProviderLink;
    ...
    private AnActionLink selectLink;
    private AnActionLink batchSupportLink;
    private AnActionLink redefineHelpLinkLabel;
    private AnActionLink ossHelpLink;
    /**
     * 主pane
     */
    ...
    private AnActionLink printConditionExpressLink;
    /**
     * 热更新之前先编译
     */
     ...
     * 更多链接
     */
    private AnActionLink mybatisMapperReloadHelpLink;
    /**
     * retransform 帮助文档
     */
    private AnActionLink retransformHelpLink;
    /**
     * arthas retransformer 热更新功能浅析
     */
    private AnActionLink analysisRetransformerLink;
    /**
     * github 地址
     */
    private AnActionLink arthasIdeaGithubLink;
    /**
     * demo 地址
     */
    private AnActionLink arthasIdeaDemoLink;
    /**
     * 语雀知识库链接
     */
    private AnActionLink arthasYuQueDocumentLink;
    /**
     * 自动转换为中文编码
     */
     ...
     * 自动将中文转换为 unicode 编码
     */
    private AnActionLink howToInputChineseParamLink;

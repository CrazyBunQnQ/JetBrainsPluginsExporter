...
//    }
    ...
    private AnActionLink ognlOfficeLinkLabel;
    private AnActionLink oglSpecialLink;
    private AnActionLink ttInvokeAfterLink;
    ...
    private AnActionLink ttInvokeBeforeHelp;
    private AnActionLink ttIndexLabel;
    /**
     * spring all 环境变量信息
     */
    ...
    private void createUIComponents() {
        ognlOfficeLinkLabel = new AnActionLink("", new AnAction() {
            @Override
        ...
        oglSpecialLink = new AnActionLink("", new AnAction() {
            @Override
            public void actionPerformed(AnActionEvent anActionEvent) {
        ...
        ttInvokeBeforeHelp = new AnActionLink("", new AnAction() {
            @Override
            public void actionPerformed(AnActionEvent anActionEvent) {
        ...
        ttIndexLabel = new AnActionLink("", new AnAction() {
            @Override
            public void actionPerformed(AnActionEvent anActionEvent) {
        ...
        ttInvokeAfterLink = new AnActionLink("", new AnAction() {
            @Override
            public void actionPerformed(AnActionEvent anActionEvent) {

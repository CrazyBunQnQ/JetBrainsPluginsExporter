...
public class ArthasActionDumpDialog extends JDialog {
    ...
    private AnActionLink dumpOfficeLinkLabel;
    ...
    private AnActionLink classLoaderLinkLable;
    ...
    private void createUIComponents() {
        ...
        dumpOfficeLinkLabel = new AnActionLink("", new AnAction() {
            @Override
        ...
        classLoaderLinkLable = new AnActionLink("", new AnAction() {
            @Override
            public void actionPerformed(AnActionEvent anActionEvent) {
